...
I also opted for installation of the [hugo](https://gohugo.io/) and [Dart](https://dart.dev/) from source directly; it turned out to give the quickest workflow executions.
